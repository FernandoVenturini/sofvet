...
// Removed duplicate declaration of medicamentoService
...
export const medicamentoService = {
	...
	async getAll(): Promise<Medicamento[]> {
		return medicamentosVeterinarios.map((medicamento) => ({
			...medicamento,
			dataCadastro: medicamento.dataCadastro || new Date(),
			dataAtualizacao: medicamento.dataAtualizacao || new Date(),
		}));
	},
