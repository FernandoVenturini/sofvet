...
import { AlertTriangle, Activity, AlertCircle, Biohazard, Skull } from 'lucide-react';
...
const Patologias = () => {
  ...
  const [selectedPatologia, setSelectedPatologia] = useState<Patologia | null>(null);
  const [selectedArtigo, setSelectedArtigo] = useState<ArtigoPubMed | null>(null);
  ...
  // Dados estáticos
  const especies = [
    'Canino', 'Felino', 'Equino', 'Bovino', 'Suíno', 'Ovino', 'Caprino', 'Aves', 'Exóticos', 'Todos'
  ];
      ...
      const patologiasMock: Patologia[] = [
        {
          ...
          diagnosticos: [
            { id: '1', nome: 'Exame direto de fluorescência', confiabilidade: 95, diferencial: false },
            { id: '2', nome: 'PCR', confiabilidade: 99, diferencial: false }
          ],
          tratamentos: [
            { id: '1', nome: 'Vacinação pós-exposição', tipo: 'preventivo', descricao: 'Administrar imediatamente após exposição' },
            { id: '2', nome: 'Eutanásia', tipo: 'terapeutico', descricao: 'Indicada para animais sintomáticos' }
          ],
          etiologia: 'Vírus RNA da família Rhabdoviridae',
          patogenese: 'Inoculação por mordida → replicação no músculo → nervos periféricos → SNC',
          epidemiologia: 'Zoonose fatal. Transmissão por saliva de animais infectados.',
          profilaxia: 'Vacinação anual obrigatória. Controle de animais errantes.',
          prognostico: 'grave',
        ...
        },
        {
          ...
          sintomas: [
            { id: '1', nome: 'Emagrecimento progressivo', frequencia: 'muito_comum' },
          ...
          diagnosticos: [
            { id: '1', nome: 'Teste rápido DPP', confiabilidade: 85, diferencial: false },
            { id: '2', nome: 'ELISA', confiabilidade: 90, diferencial: false },
            { id: '3', nome: 'PCR', confiabilidade: 95, diferencial: false }
          ],
          tratamentos: [
            { id: '1', nome: 'Antimoniato de meglumina', tipo: 'medicamentoso', descricao: '100 mg/kg/dia SC por 30 dias' },
            { id: '2', nome: 'Miltefosina', tipo: 'medicamentoso', descricao: '2 mg/kg/dia VO por 28 dias' },
            { id: '3', nome: 'Allopurinol', tipo: 'medicamentoso', descricao: '10 mg/kg/dia VO por 6-12 meses' }
          ],
          etiologia: 'Protozoário Leishmania infantum transmitido por flebotomíneos',
          patogenese: 'Picada do vetor → macrófagos → disseminação hematógena',
          epidemiologia: 'Endêmica em várias regiões do Brasil. Vetor: Lutzomyia longipalpis.',
        ...
        },
        {
          ...
          sintomas: [
            { id: '1', nome: 'Tosse seca e produtiva', frequencia: 'muito_comum' },
            { id: '2', nome: 'Espirros', frequencia: 'comum' },
            { id: '3', nome: 'Secreção nasal', frequencia: 'comum' },
            { id: '4', nome: 'Letargia', frequencia: 'raro' }
          ],
          diagnosticos: [
            { id: '1', nome: 'Exame clínico', confiabilidade: 70, diferencial: false },
            { id: '2', nome: 'PCR secreção nasal', confiabilidade: 85, diferencial: false }
          ],
          tratamentos: [
            { id: '1', nome: 'Antibioticoterapia', tipo: 'medicamentoso', descricao: 'Doxiciclina 5 mg/kg/dia VO por 7-10 dias' },
            { id: '2', nome: 'Antitussígenos', tipo: 'medicamentoso', descricao: 'Butorfanol 0.5 mg/kg SC' }
          ],
          etiologia: 'Bordetella bronchiseptica, Parainfluenza, Adenovírus canino',
          patogenese: 'Infecção das vias aéreas superiores → inflamação traqueobrônquica',
          epidemiologia: 'Altamente contagiosa em ambientes com aglomeração canina',
        ...
        },
        {
          ...
          sintomas: [
            ...
            { id: '4', nome: 'Obstrução uretral', frequencia: 'grave' }
          ],
          diagnosticos: [
            { id: '1', nome: 'Urinálise', confiabilidade: 80, diferencial: false },
            { id: '2', nome: 'Ultrassom abdominal', confiabilidade: 90, diferencial: false },
            { id: '3', nome: 'Radiografia', confiabilidade: 70, diferencial: false }
          ],
          tratamentos: [
            { id: '1', nome: 'Cateterização uretral', tipo: 'cirurgico', descricao: 'Desobstrução imediata em casos de bloqueio' },
            { id: '2', nome: 'Dieta urinária', tipo: 'terapeutico', descricao: 'Alimento específico para dissolução de cristais' },
            { id: '3', nome: 'Analgesia', tipo: 'medicamentoso', descricao: 'Buprenorfina 0.02 mg/kg SC' }
          ],
          ...
          profilaxia: 'Dieta úmida, enriquecimento ambiental, múltiplas vasilhas',
          prognostico: 'reservado',
          gravidade: 'moderada',
          zoonotica: false,
          notificavel: false,
        ...
        },
        {
          ...
          diagnosticos: [
            { id: '1', nome: 'Exame ortopédico', confiabilidade: 75, diferencial: false },
            { id: '2', nome: 'Radiografia', confiabilidade: 90, diferencial: false },
            { id: '3', nome: 'Artroscopia', confiabilidade: 95, diferencial: true }
          ],
          tratamentos: [
            { id: '1', nome: 'Carprofeno', tipo: 'medicamentoso', descricao: '4 mg/kg/dia VO' },
            { id: '2', nome: 'Fisioterapia', tipo: 'terapeutico', descricao: 'Exercícios de baixo impacto, hidroterapia' },
            { id: '3', nome: 'Condroprotetores', tipo: 'medicamentoso', descricao: 'Glicosamina + Condroitina' }
          ],
          etiologia: 'Degeneração articular primária ou secundária a outras condições',
          patogenese: 'Degradação da cartilagem → inflamação sinovial → neoformação óssea',
          epidemiologia: 'Idade avançada, raças grandes, obesidade, displasias',
          profilaxia: 'Controle de peso, exercícios regulares, suplementação precoce',
          prognostico: 'favoravel',
          gravidade: 'moderada',
          zoonotica: false,
          notificavel: false,
      ...
      const artigosMock: ArtigoPubMed[] = [
        {
          ...
          resumo: 'Study of rabies virus pathogenesis and immune response in canine models...'
        },
        {
          id: '23456789',
          ...
          resumo: 'Analysis of rabies epidemiology in urban canine populations...'
        }
      ];
  ...
  const filteredPatologias = patologias.filter(patologia => {
    const matchesSearch = !searchTerm || 
      ...
      patologia.nomeCientifico.toLowerCase().includes(searchTerm.toLowerCase()) ||
      patologia.codigoICD10.includes(searchTerm) ||
      patologia.sintomas.some(s => s.nome.toLowerCase().includes(searchTerm.toLowerCase()));
    
    const matchesEspecie = filterEspecie === 'todas' || patologia.especies.includes(filterEspecie);
    const matchesSistema = filterSistema === 'todos' || patologia.sistemasAfetados.includes(filterSistema);
    const matchesGravidade = filterGravidade === 'todas' || patologia.gravidade === filterGravidade;
    const matchesZoonotica = filterZoonotica === 'todos' || 
      (filterZoonotica === 'sim' && patologia.zoonotica) ||
      (filterZoonotica === 'nao' && !patologia.zoonotica);
    
    return matchesSearch && matchesEspecie && matchesSistema && matchesGravidade && matchesZoonotica;
  });
      ...
      const resultadosMock = [
        {
          ...
          abstract: 'Recent advances in understanding canine parvovirus pathogenesis...'
        },
        {
          pmid: '89012345',
          ...
          abstract: 'Comprehensive review of FeLV diagnosis and treatment options...'
        }
      ];
  ...
  const handleDeletePatologia = async (id: string, nome: string) => {
    if (!confirm(`Excluir a patologia "${nome}"? Esta ação não pode ser desfeita.`)) {
      return;
    }
  ...
  const resetForm = () => {
    ...
    setDiagnosticos([{ id: '1', nome: '', confiabilidade: 80, diferencial: false }]);
    setTratamentos([{ id: '1', nome: '', tipo: 'medicamentoso', descricao: '' }]);
  ...
  const estatisticas = {
    ...
    especiesAfetadas: [...new Set(patologias.flatMap(p => p.especies))].length,
    sistemasAfetados: [...new Set(patologias.flatMap(p => p.sistemasAfetados))].length
  };
      ...
      <div className="max-w-full mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
          <div>
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                <h1 className="text-2xl md:text-3xl font-bold text-white">Patologias Veterinárias</h1>
                <p className="text-gray-400 text-sm md:text-base">Banco de dados completo de doenças animais com IA integrada</p>
              </div>
            </div>
            <div className="flex flex-wrap items-center gap-2 mt-2">
              ...
              <span className="text-xs text-gray-500">• Diagnóstico inteligente • Artigos científicos • Epidemiologia</span>
            </div>
          </div>
          ...
          <CardContent className="p-4 md:p-6">
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
              <div className="flex-1">
                <h3 className="text-lg font-semibold text-white mb-2">SofVet AI - Diagnóstico Assistido</h3>
                <p className="text-gray-400 text-sm">
                  Descreva os sintomas e nosso sistema de IA sugerirá possíveis diagnósticos com base no banco de dados
                </p>
              </div>
              <div className="flex gap-2">
                <Button
                  ...
                  onClick={() => {/* Abrir diagnóstico por IA */}}
                >
            ...
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-gray-500">{estatisticas.especiesAfetadas} espécies</p>
                </div>
                <Virus className="h-8 w-8 text-red-500 bg-red-500/20 p-1 rounded-lg" />
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xl font-bold text-orange-500">{estatisticas.zoonoticas}</p>
                  <p className="text-xs text-gray-500">Transmissíveis ao humano</p>
                </div>
            ...
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xl font-bold text-blue-500">{estatisticas.casosTotais}</p>
            ...
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xl font-bold text-red-500">{estatisticas.emergencias}</p>
          ...
          <CardContent className="p-4 md:p-6">
            <div className="flex flex-col lg:flex-row gap-4">
              <div className="relative flex-1">
                ...
                <p className="text-xs text-gray-500 mt-2">
                  <strong>SofVet AI:</strong> Busca em sintomas, diagnósticos, tratamentos e artigos científicos
                </p>
              </div>
              <div className="flex flex-col sm:flex-row gap-2">
                <Select value={filterEspecie} onValueChange={setFilterEspecie}>
                  ...
                  <SelectContent className="bg-black border-red-600/30">
                    <SelectItem value="todas" className="text-white focus:bg-red-600/20">Todas</SelectItem>
                    {especies.slice(0, -1).map(esp => (
                      <SelectItem key={esp} value={esp} className="text-white focus:bg-red-600/20">
                        {esp}
                      </SelectItem>
                    ))}
                  </SelectContent>
                ...
                <Select value={filterSistema} onValueChange={setFilterSistema}>
                  ...
                  <SelectContent className="bg-black border-red-600/30">
                    ...
                    {sistemasCorporais.map(sistema => (
                      <SelectItem key={sistema} value={sistema} className="text-white focus:bg-red-600/20">
                        {sistema}
                      </SelectItem>
                    ))}
                  </SelectContent>
                ...
                <Select value={filterGravidade} onValueChange={setFilterGravidade}>
                  ...
                  <SelectContent className="bg-black border-red-600/30">
                    <SelectItem value="todas" className="text-white focus:bg-red-600/20">Todas</SelectItem>
                    {gravidades.map(g => (
                      <SelectItem key={g.value} value={g.value} className="text-white focus:bg-red-600/20">
                        {g.label}
                      </SelectItem>
                    ))}
                  </SelectContent>
            ...
            <div className="flex flex-wrap gap-4 mt-4">
              <div className="flex items-center space-x-2">
                <Label htmlFor="zoonotica" className="text-white text-sm">Zoonose:</Label>
                <Select value={filterZoonotica} onValueChange={setFilterZoonotica}>
                  <SelectTrigger className="w-[100px] bg-black/30 border-red-600/50 text-white">
                    <SelectValue placeholder="Todos" />
                  </SelectTrigger>
                  <SelectContent className="bg-black border-red-600/30">
                    <SelectItem value="todos" className="text-white focus:bg-red-600/20">Todos</SelectItem>
                    <SelectItem value="sim" className="text-white focus:bg-red-600/20">Sim</SelectItem>
                    <SelectItem value="nao" className="text-white focus:bg-red-600/20">Não</SelectItem>
                  </SelectContent>
                </Select>
              </div>
              ...
              <div className="flex items-center space-x-2">
                ...
                />
                <Label htmlFor="notificavel" className="text-white text-sm">Apenas doenças de notificação obrigatória</Label>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="mb-6 bg-black/50 border-red-600/30 overflow-hidden">
          <CardHeader className="border-b border-red-600/30">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
              <div>
                <CardTitle className="text-white">Patologias Cadastradas</CardTitle>
                <CardDescription className="text-gray-400">
                  {filteredPatologias.length} de {patologias.length} patologias • {estatisticas.casosTotais} casos registrados
                </CardDescription>
              </div>
              <div className="flex gap-2">
                <Button
          ...
          <CardContent className="p-0">
            {loading ? (
              ...
              <div className="text-center py-12">
                ...
                <h3 className="text-lg font-semibold text-gray-300 mb-2">Nenhuma patologia encontrada</h3>
                  ...
                  <Table className="min-w-full">
                    <TableHeader>
                      <TableRow className="border-red-600/30">
                        <TableHead className="text-white bg-black/30">Patologia</TableHead>
                        <TableHead className="text-white bg-black/30">Espécies</TableHead>
                        <TableHead className="text-white bg-black/30">Sintomas</TableHead>
                        <TableHead className="text-white bg-black/30">Gravidade</TableHead>
                        <TableHead className="text-white bg-black/30">Casos</TableHead>
                        <TableHead className="text-right text-white bg-black/30">Ações</TableHead>
                      </TableRow>
                    </TableHeader>
                    <TableBody>
                      {filteredPatologias.map((patologia) => {
                        const gravidadeConfig = gravidades.find(g => g.value === patologia.gravidade);
                        const prognosticoConfig = prognosticos.find(p => p.value === patologia.prognostico);
                        
                        return (
                          <TableRow key={patologia.id} className="border-red-600/30 hover:bg-red-600/10">
                            <TableCell className="font-medium text-white">
                              <div className="flex items-center gap-3">
                                <div className={`p-2 rounded-lg ${gravidadeConfig?.color} bg-opacity-20`}>
                                  <Virus className="h-5 w-5" />
                                </div>
                                <div>
                                  <div className="flex items-center gap-2">
                                    <span className="font-semibold">{patologia.nome}</span>
                                    {patologia.zoonotica && (
                                      <AlertTriangle className="h-4 w-4 text-orange-500" title="Zoonose" />
                                    )}
                                    {patologia.notificavel && (
                                      <Badge className="bg-red-600 text-xs">Notificação</Badge>
                                    )}
                                  </div>
                                  <div className="text-xs text-gray-400">{patologia.nomeCientifico}</div>
                                  <div className="text-xs text-gray-500">ICD-10: {patologia.codigoICD10}</div>
                                </div>
                              </div>
                            </TableCell>
                            <TableCell className="text-white">
                              <div className="flex flex-wrap gap-1">
                                {patologia.especies.slice(0, 3).map((esp, idx) => (
                                  <Badge key={idx} variant="outline" className="text-xs bg-black/30 border-red-600/30 text-white">
                                    {esp}
                                  </Badge>
                                ))}
                            ...
                            <TableCell className="text-white max-w-[250px]">
                              <div className="text-sm truncate" title={patologia.sintomas.map(s => s.nome).join(', ')}>
                                {patologia.sintomas.slice(0, 2).map(s => s.nome).join(', ')}
                                {patologia.sintomas.length > 2 && '...'}
                              </div>
                              <div className="text-xs text-gray-400">
                                {patologia.sistemasAfetados[0]}
                                {patologia.sistemasAfetados.length > 1 && ` +${patologia.sistemasAfetados.length - 1}`}
                              </div>
                            </TableCell>
                            <TableCell>
                              <div className="flex items-center gap-2">
                                <Badge className={`${gravidadeConfig?.color} text-xs`}>
                                  {gravidadeConfig?.label}
                                </Badge>
                                <Badge variant="outline" className={`border-${prognosticoConfig?.color.split('-')[1]}-600/50 text-xs`}>
                            ...
                            <TableCell className="text-white">
                              <div className="flex items-center">
                                <span className={patologia.casosRegistrados > 100 ? "font-semibold text-amber-300" : "text-gray-300"}>
                            ...
                            <TableCell className="text-right">
                              <div className="flex justify-end gap-1">
                                ...
                                <Button
                                  ...
                                  onClick={() => handleDeletePatologia(patologia.id, patologia.nome)}
                                  title="Excluir"
                                >
              ...
              <div className="flex gap-2">
                <div className="relative flex-1">
                  ...
                  <Input
                    ...
                    onKeyPress={(e) => e.key === 'Enter' && buscarArtigosPubMed()}
                  />
                </div>
                <Button 
              ...
              {resultadosPubMed.length > 0 ? (
                <div className="space-y-3 max-h-96 overflow-y-auto">
                  ...
                  {resultadosPubMed.map((artigo) => (
                    <Card key={artigo.pmid} className="bg-black/50 border-blue-600/30">
                      <CardContent className="p-4">
                        <div className="flex justify-between items-start">
                          <div className="flex-1">
                            <h5 className="font-semibold text-white mb-1">{artigo.title}</h5>
                            <p className="text-sm text-gray-400 mb-2">
                              {artigo.authors} • {artigo.journal} • {artigo.pubyear}
                            </p>
                            <p className="text-xs text-gray-500 line-clamp-2">{artigo.abstract}</p>
                          </div>
                ...
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-400">Nenhum artigo encontrado para "{buscaPubMed}"</p>
                  <p className="text-sm text-gray-500 mt-2">Tente outros termos em inglês</p>
                </div>
              ) : (
                <div className="text-center py-8">
                  <Cloud className="h-12 w-12 text-blue-600 mx-auto mb-4" />
                  <p className="text-gray-400">Busque artigos científicos no PubMed</p>
        ...
        <Dialog open={isDetailsOpen} onOpenChange={setIsDetailsOpen}>
          <DialogContent className="max-w-4xl bg-black/90 border-red-600/30 text-white">
            <DialogHeader>
              <DialogTitle className="text-white">Detalhes da Patologia</DialogTitle>
            </DialogHeader>
            ...
            {selectedPatologia && (
              <div className="space-y-6 py-4 max-h-[80vh] overflow-y-auto">
                ...
                <div className="flex items-start justify-between">
                  <div>
                    <div className="flex items-center gap-3 mb-2">
                      <div className={`p-3 rounded-lg ${gravidades.find(g => g.value === selectedPatologia.gravidade)?.color} bg-opacity-20`}>
                        <Virus className="h-6 w-6" />
                      </div>
                      <div>
                        <h3 className="text-2xl font-bold text-white">{selectedPatologia.nome}</h3>
                        <p className="text-gray-400">{selectedPatologia.nomeCientifico}</p>
                      </div>
                    </div>
                    <div className="flex flex-wrap gap-2 mt-3">
                      <Badge className="bg-gray-700">ICD-10: {selectedPatologia.codigoICD10}</Badge>
                      {selectedPatologia.zoonotica && <Badge className="bg-orange-600">Zoonose</Badge>}
                      {selectedPatologia.notificavel && <Badge className="bg-red-600">Notificação Obrigatória</Badge>}
                      <Badge className={`${gravidades.find(g => g.value === selectedPatologia.gravidade)?.color}`}>
                        Gravidade: {gravidades.find(g => g.value === selectedPatologia.gravidade)?.label}
                      </Badge>
                      <Badge className={`${prognosticos.find(p => p.value === selectedPatologia.prognostico)?.color}`}>
                        Prognóstico: {prognosticos.find(p => p.value === selectedPatologia.prognostico)?.label}
                      </Badge>
                    </div>
                  </div>
                  <div className="text-right">
                    <p className="text-3xl font-bold text-red-400">{selectedPatologia.casosRegistrados}</p>
                ...
                <Tabs defaultValue="geral" className="w-full">
                  <TabsList className="grid w-full grid-cols-5 bg-black/30 border border-red-600/30">
                    <TabsTrigger value="geral" className="text-white data-[state=active]:bg-red-600/50">Geral</TabsTrigger>
                    <TabsTrigger value="sintomas" className="text-white data-[state=active]:bg-red-600/50">Sintomas</TabsTrigger>
                    <TabsTrigger value="diagnostico" className="text-white data-[state=active]:bg-red-600/50">Diagnóstico</TabsTrigger>
                    <TabsTrigger value="tratamento" className="text-white data-[state=active]:bg-red-600/50">Tratamento</TabsTrigger>
                    <TabsTrigger value="artigos" className="text-white data-[state=active]:bg-red-600/50">Artigos</TabsTrigger>
                  </TabsList>
                  ...
                  <TabsContent value="geral" className="space-y-4 pt-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-4">
                        <div>
                          <h4 className="text-sm font-semibold text-gray-400 mb-2">Espécies Afetadas</h4>
                          <div className="flex flex-wrap gap-2">
                            {selectedPatologia.especies.map((especie, idx) => (
                              <Badge key={idx} variant="outline" className="border-red-600/30 text-white">
                                {especie}
                              </Badge>
                            ))}
                          </div>
                        ...
                        <div>
                          <h4 className="text-sm font-semibold text-gray-400 mb-2">Sistemas Afetados</h4>
                          <div className="flex flex-wrap gap-2">
                            {selectedPatologia.sistemasAfetados.map((sistema, idx) => (
                              <Badge key={idx} variant="outline" className="border-purple-600/30 text-purple-300">
                                {sistema}
                              </Badge>
                            ))}
                          </div>
                      ...
                      <div className="space-y-4">
                        <div>
                          <h4 className="text-sm font-semibold text-gray-400 mb-2">Etiologia</h4>
                    ...
                    <div className="space-y-4">
                      <div>
                        <h4 className="text-sm font-semibold text-gray-400 mb-2">Patogênese</h4>
                        <p className="text-white bg-black/30 p-3 rounded border border-red-600/30">
                      ...
                      <div>
                        <h4 className="text-sm font-semibold text-gray-400 mb-2">Epidemiologia</h4>
                        <p className="text-white bg-black/30 p-3 rounded border border-red-600/30">
                      ...
                      <div>
                        <h4 className="text-sm font-semibold text-gray-400 mb-2">Profilaxia</h4>
                        <p className="text-white bg-black/30 p-3 rounded border border-red-600/30">
                    ...
                    <div className="space-y-4">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {selectedPatologia.sintomas.map((sintoma, idx) => (
                          <Card key={sintoma.id} className="bg-black/30 border-red-600/30">
                            <CardContent className="p-4">
                              <div className="flex justify-between items-center">
                                <div>
                                  <h4 className="font-semibold text-white">{sintoma.nome}</h4>
                                  <div className="flex items-center gap-2 mt-2">
                                    <Badge className={`
                                      ${sintoma.frequencia === 'muito_comum' ? 'bg-green-600' : 
                                        sintoma.frequencia === 'comum' ? 'bg-yellow-600' : 'bg-gray-600'}
                                      text-xs
                                    `}>
                                      {sintoma.frequencia === 'muito_comum' ? 'Muito Comum' :
                                       sintoma.frequencia === 'comum' ? 'Comum' : 'Raro'}
                                    </Badge>
                                  </div>
                                </div>
                  ...
                  <TabsContent value="diagnostico" className="pt-4">
                    <div className="space-y-4">
                      {selectedPatologia.diagnosticos.map((diagnostico, idx) => (
                        <Card key={diagnostico.id} className="bg-black/30 border-blue-600/30">
                          <CardContent className="p-4">
                            <div className="flex justify-between items-start">
                              <div>
                                <div className="flex items-center gap-3 mb-2">
                                  <h4 className="font-semibold text-white">{diagnostico.nome}</h4>
                                  {diagnostico.diferencial && (
                                    <Badge className="bg-purple-600 text-xs">Diagnóstico Diferencial</Badge>
                                  )}
                                </div>
                                  ...
                                  <div className="flex items-center gap-2">
                                    <div className="w-32 bg-gray-700 rounded-full h-2">
                                      <div 
                                        ...
                                        style={{ width: `${diagnostico.confiabilidade}%` }}
                                      />
                                    </div>
                                    <span className="text-sm text-gray-300">{diagnostico.confiabilidade}%</span>
                                  </div>
                                  <span className="text-sm text-gray-400">Confiabilidade</span>
                                </div>
                              </div>
                  ...
                  <TabsContent value="tratamento" className="pt-4">
                    <div className="space-y-4">
                      {selectedPatologia.tratamentos.map((tratamento, idx) => {
                        ...
                        return (
                          <Card key={tratamento.id} className="bg-black/30 border-green-600/30">
                            <CardContent className="p-4">
                              <div className="flex justify-between items-start">
                                <div className="flex-1">
                                  <div className="flex items-center gap-3 mb-2">
                                    <h4 className="font-semibold text-white">{tratamento.nome}</h4>
                                    <Badge className={`${tipoCor} text-xs`}>
                                      {tipoLabel}
                                    </Badge>
                                  </div>
                                  <p className="text-gray-300">{tratamento.descricao}</p>
                                </div>
                  ...
                  <TabsContent value="artigos" className="pt-4">
                    <div className="space-y-4">
                      {getArtigosPorIds(selectedPatologia.artigosPubMed).length > 0 ? (
                        getArtigosPorIds(selectedPatologia.artigosPubMed).map((artigo) => (
                          <Card key={artigo.id} className="bg-black/30 border-blue-600/30">
                            <CardContent className="p-4">
                              <div className="flex justify-between items-start">
                                <div>
                                  <h4 className="font-semibold text-white mb-1">{artigo.titulo}</h4>
                                  <p className="text-sm text-gray-400 mb-2">
                                    {artigo.autores.join(', ')} • {artigo.revista} • {artigo.ano}
                                  </p>
                                  <p className="text-xs text-gray-500 line-clamp-2">{artigo.resumo}</p>
                                </div>
                                <div className="flex flex-col gap-2 ml-4">
                                  <Button
                                    size="sm"
                        ...
                        <div className="text-center py-8">
                          <BookOpen className="h-12 w-12 text-gray-600 mx-auto mb-4" />
                          <p className="text-gray-400">Nenhum artigo científico vinculado</p>
                          <Button
                            variant="outline"
                ...
                <div className="flex justify-between">
                  ...
                  <div className="flex gap-2">
                    <Button
                      variant="outline"
                      className="border-gray-600/50 text-gray-300 hover:bg-gray-600/20"
                      onClick={() => navigator.clipboard.writeText(JSON.stringify(selectedPatologia, null, 2))}
                    >
                    ...
                    <Button
                      ...
                      onClick={() => handleDeletePatologia(selectedPatologia.id, selectedPatologia.nome)}
                    >
          ...
          <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto bg-black/90 border-red-600/30 text-white">
            ...
            <Tabs defaultValue="basico" className="w-full">
              <TabsList className="grid w-full grid-cols-4 bg-black/30 border border-red-600/30">
                <TabsTrigger value="basico" className="text-white data-[state=active]:bg-red-600/50">Básico</TabsTrigger>
                <TabsTrigger value="sintomas" className="text-white data-[state=active]:bg-red-600/50">Sintomas</TabsTrigger>
                <TabsTrigger value="diagnostico" className="text-white data-[state=active]:bg-red-600/50">Diagnóstico</TabsTrigger>
                <TabsTrigger value="tratamento" className="text-white data-[state=active]:bg-red-600/50">Tratamento</TabsTrigger>
              </TabsList>
              ...
              <TabsContent value="basico" className="space-y-4 py-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-4">
                    <div>
                      <Label htmlFor="codigoICD10" className="text-white">Código ICD-10</Label>
                      <Input
                        id="codigoICD10"
                        value={formData.codigoICD10}
                        onChange={(e) => setFormData({...formData, codigoICD10: e.target.value})}
                    ...
                    <div>
                      <Label htmlFor="nome" className="text-white">Nome da Patologia *</Label>
                      <Input
                        id="nome"
                        value={formData.nome}
                    ...
                    <div>
                      <Label htmlFor="nomeCientifico" className="text-white">Nome Científico *</Label>
                      <Input
                        id="nomeCientifico"
                    ...
                    <div>
                      <Label className="text-white mb-2 block">Espécies Afetadas</Label>
                      <div className="flex flex-wrap gap-2">
                        {especies.slice(0, -1).map(especie => (
                          <Badge
                            key={especie}
                            variant={formData.especies.includes(especie) ? "default" : "outline"}
                            className={`cursor-pointer ${formData.especies.includes(especie) ? 'bg-red-600' : 'border-red-600/30 text-white'}`}
                            onClick={() => {
                              const novasEspecies = formData.especies.includes(especie)
                                ? formData.especies.filter(e => e !== especie)
                                : [...formData.especies, especie];
                              setFormData({...formData, especies: novasEspecies});
                            }}
                          >
                            {especie}
                          </Badge>
                  ...
                  <div className="space-y-4">
                    <div>
                      <Label className="text-white mb-2 block">Sistemas Afetados</Label>
                      <div className="flex flex-wrap gap-2">
                        {sistemasCorporais.map(sistema => (
                          <Badge
                            key={sistema}
                            variant={formData.sistemasAfetados.includes(sistema) ? "default" : "outline"}
                            className={`cursor-pointer ${formData.sistemasAfetados.includes(sistema) ? 'bg-purple-600' : 'border-purple-600/30 text-white'}`}
                            onClick={() => {
                              const novosSistemas = formData.sistemasAfetados.includes(sistema)
                                ? formData.sistemasAfetados.filter(s => s !== sistema)
                                : [...formData.sistemasAfetados, sistema];
                              setFormData({...formData, sistemasAfetados: novosSistemas});
                            }}
                          >
                            {sistema}
                          </Badge>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <Label htmlFor="gravidade" className="text-white">Gravidade</Label>
                        <Select value={formData.gravidade} onValueChange={(value: any) => setFormData({...formData, gravidade: value})}>
                      ...
                      <div>
                        <Label htmlFor="prognostico" className="text-white">Prognóstico</Label>
                        <Select value={formData.prognostico} onValueChange={(value: any) => setFormData({...formData, prognostico: value})}>
                          <SelectTrigger className="bg-black/30 border-red-600/50 text-white">
                            <SelectValue />
                          </SelectTrigger>
                          <SelectContent className="bg-black border-red-600/30">
                            {prognosticos.map(p => (
                              <SelectItem key={p.value} value={p.value} className="text-white focus:bg-red-600/20">
                                {p.label}
                              </SelectItem>
                            ))}
                          </SelectContent>
                    ...
                    <div className="flex items-center space-x-4">
                      <div className="flex items-center space-x-2">
                        <input
                          ...
                          onChange={(e) => setFormData({...formData, zoonotica: e.target.checked})}
                          className="rounded border-red-600 bg-black/30"
                        />
                        <Label htmlFor="zoonotica" className="text-white">Zoonose</Label>
                      </div>
                      ...
                      <div className="flex items-center space-x-2">
                        <input
                          ...
                          onChange={(e) => setFormData({...formData, notificavel: e.target.checked})}
                          className="rounded border-red-600 bg-black/30"
                        />
                        <Label htmlFor="notificavel" className="text-white">Notificação Obrigatória</Label>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  <div>
                    <Label htmlFor="etiologia" className="text-white">Etiologia</Label>
                    <Textarea
                      id="etiologia"
                      value={formData.etiologia}
                      onChange={(e) => setFormData({...formData, etiologia: e.target.value})}
                  ...
                  <div>
                    <Label htmlFor="patogenese" className="text-white">Patogênese</Label>
                    <Textarea
                      id="patogenese"
                      value={formData.patogenese}
                      onChange={(e) => setFormData({...formData, patogenese: e.target.value})}
                  ...
                  <div className="p-6 bg-gradient-to-br from-gray-900 to-black min-h-screen">
                    <textarea
                      ...
                      onChange={(e) => setFormData({ ...formData, epidemiologia: e.target.value })}
                  ...
                  <div>
                    <Label htmlFor="profilaxia" className="text-white">Profilaxia</Label>
                    <Textarea
                      id="profilaxia"
                      value={formData.profilaxia}
                      onChange={(e) => setFormData({...formData, profilaxia: e.target.value})}
              ...
              <TabsContent value="sintomas" className="space-y-4 py-4">
                <div className="space-y-4">
                  ...
                  {sintomas.map((sintoma, index) => (
                    <div key={sintoma.id} className="flex flex-col sm:flex-row items-center gap-3 p-3 border border-red-600/30 rounded-lg">
                      ...
                      <div className="w-full sm:w-32">
                        <Label className="text-white mb-1 block">Frequência</Label>
                        <Select
                        ...
                        >
                          ...
                          <SelectContent className="bg-black border-red-600/30">
                            <SelectItem value="raro" className="text-white focus:bg-red-600/20">Raro</SelectItem>
                            <SelectItem value="comum" className="text-white focus:bg-red-600/20">Comum</SelectItem>
                            <SelectItem value="muito_comum" className="text-white focus:bg-red-600/20">Muito Comum</SelectItem>
                          </SelectContent>
                        </Select>
                      </div>
                      <Button
              ...
              <TabsContent value="diagnostico" className="space-y-4 py-4">
                <div className="space-y-4">
                  <h3 className="text-lg font-semibold text-white">Diagnósticos</h3>
                  {diagnosticos.map((diagnostico, index) => (
                    <div key={diagnostico.id} className="flex flex-col sm:flex-row items-center gap-3 p-3 border border-red-600/30 rounded-lg">
                      <div className="flex-1 w-full">
                        <Label className="text-white mb-1 block">Método de Diagnóstico</Label>
                        <Input
                      ...
                      <div className="w-full sm:w-32">
                        <Label className="text-white mb-1 block">Confiabilidade (%)</Label>
                        <Input
                          type="number"
                          min="0"
                          max="100"
                          ...
                          onChange={(e) => {
                            const novosDiagnosticos = [...diagnosticos];
                            novosDiagnosticos[index].confiabilidade = parseInt(e.target.value) || 0;
                            setDiagnosticos(novosDiagnosticos);
                          }}
                          className="bg-black/30 border-red-600/50 text-white"
                        />
                      ...
                      <div className="flex items-center gap-2">
                        <div className="flex items-center">
                          <input
                            ...
                            onChange={(e) => {
                              const novosDiagnosticos = [...diagnosticos];
                              novosDiagnosticos[index].diferencial = e.target.checked;
                              setDiagnosticos(novosDiagnosticos);
                            }}
                            className="rounded border-red-600 bg-black/30 mr-2"
                          />
                          <Label htmlFor={`diferencial-${index}`} className="text-white text-sm">Diferencial</Label>
                        </div>
                        <Button
                          variant="ghost"
                          size="sm"
                          ...
                          onClick={() => {
                            const novosDiagnosticos = diagnosticos.filter((_, i) => i !== index);
                            setDiagnosticos(novosDiagnosticos);
                          }}
                        >
                          <Trash2 className="h-4 w-4" />
              ...
              <TabsContent value="tratamento" className="space-y-4 py-4">
                <div className="space-y-4">
                  <h3 className="text-lg font-semibold text-white">Tratamentos</h3>
                  {tratamentos.map((tratamento, index) => (
                    <div key={tratamento.id} className="flex flex-col gap-3 p-3 border border-red-600/30 rounded-lg">
                      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                        <div>
                          <Label className="text-white mb-1 block">Tratamento</Label>
                          <Input
                        ...
                        <div>
                          ...
                          >
                            ...
                            <SelectContent className="bg-black border-red-600/30">
                              <SelectItem value="medicamentoso" className="text-white focus:bg-red-600/20">Medicamentoso</SelectItem>
                              <SelectItem value="cirurgico" className="text-white focus:bg-red-600/20">Cirúrgico</SelectItem>
                              <SelectItem value="terapeutico" className="text-white focus:bg-red-600/20">Terapêutico</SelectItem>
                              <SelectItem value="preventivo" className="text-white focus:bg-red-600/20">Preventivo</SelectItem>
                            </SelectContent>
                          </Select>
                        </div>
                        <div className="flex items-end">
                          <Button
                            ...
                            className="text-red-400 hover:bg-red-600/20 hover:text-red-300"
                            onClick={() => {
                              const novosTratamentos = tratamentos.filter((_, i) => i !== index);
                              setTratamentos(novosTratamentos);
                            }}
                          >
                            <Trash2 className="h-4 w-4" />
