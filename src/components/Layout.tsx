...
import {
    ...
    Database, HelpCircle, Search,
    Pill, Activity, Bell,
    BarChart3, Calculator, Heart, Shield,
    LayoutDashboard, Stethoscope, Dog,
    X
} from 'lucide-react';
    ...
    const menuItems = [
        ...
        },
        {
            ...
            subItems: [
                ...
                { title: 'Produtos e Serviços', path: '/tabelas/produtos' },
                ...
                <div className="p-6 border-b border-border">
                    <div className="flex items-center space-x-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-muted-foreground">Sistema Veterinário</p>
                        </div>
                    </div>
                </div>
                                    ...
                                    {item.subItems ? (
                                        <Accordion type="single" collapsible>
                                            <AccordionItem value={item.title} className="border-none">
                                                <AccordionTrigger
                                                    className={cn(
                                                        "flex items-center justify-between w-full px-3 py-2.5 rounded-lg hover:bg-accent hover:text-accent-foreground transition-colors",
                                                    ...
                                                    <div className="ml-9 space-y-1">
                                                        {item.subItems.map((subItem) => (
                                                            <Link
                                                                key={subItem.path}
                                                                to={subItem.path}
                                                                className="block py-2 px-3 rounded-lg text-sm text-muted-foreground hover:text-foreground hover:bg-accent transition-colors"
                                                            >
                                                                {subItem.title}
                                                            </Link>
                                                        ))}
                                        ...
                                        <Link
                                            to={item.path}
                                            className={cn(
                                                "flex items-center space-x-3 px-3 py-2.5 rounded-lg hover:bg-accent hover:text-accent-foreground transition-colors",
                                                active && "bg-accent text-accent-foreground"
                                            )}
                                        >
                                            <item.icon className={cn("h-5 w-5", item.color)} />
                    ...
                    <div className="mt-8 p-4 bg-secondary/50 rounded-xl">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <div className="text-center p-3 bg-secondary rounded-lg">
                                <p className="text-2xl font-bold text-foreground">{animais.length}</p>
                ...
                <div className="p-4 border-t border-border">
                    <div className="flex items-center space-x-3">
                        ...
                        <div className="flex-1 min-w-0">
                            ...
                            <p className="text-xs text-muted-foreground truncate">Veterinário</p>
                        </div>
                        <Button
                            variant="ghost"
                            size="icon"
                        ...
                        <div className="flex-1 max-w-2xl mx-4 flex items-center space-x-2">
                            <div className="relative flex-1">
                                ...
                                <Input
                                    ...
                                    className="pl-10 bg-secondary border-border text-foreground placeholder:text-muted-foreground focus:ring-2 focus:ring-ring focus:border-transparent"
                                />
                                                    ...
                                                    {result.type === 'animal' ? (
                                                        <>
                                                            ...
                                                            <div>
                                                                ...
                                                                <p className="text-sm text-muted-foreground">{result.nomeProprietario}</p>
                                                            </div>
                                                        </>
                                                        ...
                                                        <>
                                                            ...
                                                            <div>
                                                                ...
                                                                <p className="text-sm text-muted-foreground">R$ {result.total?.toFixed(2) || '0.00'}</p>
                                                            </div>
                                                        </>
                                                    ) : (
                                                        <>
                            ...
                            {/* Botão de alternância de tema, ao lado da barra de busca */}
                            <ThemeToggle />
                        </div>
